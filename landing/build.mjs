...
//
// The repo root has a .nojekyll, so GitHub Pages serves the generated index.html as is.
...
const SVG_DIR = "images/landing";      // where the remaining minified svgs go, relative to the output root
...
if (plain) {
  ...
  // keyframes are attached to. So an animated SVG -- CSS keyframes or SMIL -- gets only cosmetic plugins
  // that never restructure elements. Static SVGs get the full default preset.
